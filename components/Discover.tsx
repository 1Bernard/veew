...
const Discover = () => {
    ...
    const activeTopicStyle = 'xl:border-2 hover:bg-primary xl:border-[#f51997] px-3 py-2 rounded xl:rounded-full flex items-center justify-center gap-2 cursor-pointer text-[#f51997]'
